  ...
  return (
    <div className="w-full  items-center flex flex-col mt-5">
      ...
      <div className="download flex justify-between w-full">
        {/* 圖表、數值轉換按鈕 */}
        <div className="relative leftLink flex items-center min-w-[180px]">
          <select
            className="w-full  h-10 px-2 border-b-2 bg-white text-gray-700  focus:outline-none hover:text-[#948469] hover:border-b-[#948469] appearance-none"
          ...
          >
            ...
            <option value="option1">MGM</option>
            <option value="option2">點擊下載桌布按鈕</option>
            <option value="option3">點擊分享摯友按鈕</option>
            {/* 添加更多選項 */}
          </select>
